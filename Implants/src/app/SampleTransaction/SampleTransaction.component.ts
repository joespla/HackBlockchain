...
export class SampleTransactionComponent implements OnInit {
  ...
  private currentId;
	private errorMessage;
          ...
          newHospital = new FormControl("", Validators.required);
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: "org.example.mynetwork.SampleTransaction",
          ...
          "newHospital":this.newHospital.value,
    ...
    .then((result) => {
      ...
      let formObject = {
        ...
        if(result.organ){
            ...
            formObject.organ = result.organ;
          
        }else{
          formObject.organ = null;
        }
      
        if(result.newHospital){
          
            formObject.newHospital = result.newHospital;
          
        }else{
          formObject.newHospital = null;
        }
